				...
				<div class="sumary-product single-layout">
					<div class="media">
						<ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
							<li><img src="{{asset('assets/images/products/p-'.$product->image_id.'.jpg')}}" alt="" width="500" height="500"></li>
							<li><img src="{{asset('assets/images/products/p-'.$product->image_id.'.jpg')}}" alt="" width="500" height="500"></li>
							<li><img src="{{asset('assets/images/products/p-'.$product->image_id.'.jpg')}}" alt="" width="500" height="500"></li>
							<li><img src="{{asset('assets/images/products/p-'.$product->image_id.'.jpg')}}" alt="" width="500" height="500"></li>
							<li><img src="{{asset('assets/images/products/p-'.$product->image_id.'.jpg')}}" alt="" width="500" height="500"></li>
						...
						<ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
							<li><img src="{{asset('assets/images/details-product/thumb_p04.jpg')}}" alt="" width="88" height="88"></li>
					...
					<div class="product-attribute">
						...
						<div class="rating">
							<p class="star-rating"><span class="width-10percent"></span></p>
						...
						<div class="price">
							<ins><span class="price-amount"><span class="currencySymbol">Bs </span>{{$product->current_price}}</span></ins>
							<del><span class="price-amount"><span class="currencySymbol">Bs</span>{{$product->previous_price}}</span></del>
						</div>
						<div class="shipping-info">
							{{-- <p class="shipping-day">Se realizan envíos al interior del país.</p> --}}
							<p class="for-today">Se realizan envíos al interior del país.</p>
